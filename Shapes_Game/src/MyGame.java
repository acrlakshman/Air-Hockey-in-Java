...
public class MyGame extends Game {
  ...
  public void setup() {
	...
	// create middle partition
	  Rectangle line = new Rectangle(new Point(Game.WIDTH / 2., Game.HEIGHT * .65), 2, Game.HEIGHT * .9);
  ...
  public void update() {
	  ...
	  //Game.setSubtitle(playerNames[0]);
	  
	  // score board
	  Game.setSubtitle(score);
	  Game.getSubtitleStyle().setColor(Color.WHITE);
